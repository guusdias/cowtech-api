...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference("Treatment.count") do
      post treatments_url, params: { treatment: { date: @treatment.date, description: @treatment.description, type: @treatment.type } }, as: :json
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { date: @treatment.date, description: @treatment.description, type: @treatment.type } }, as: :json
    assert_response :success
  end
